...
</font><a href="inputtool.asp"><font face="TH Baijam" color="#DA4453">เพิ่มข้อมูลเครื่องมือ</font></a><font face="TH Baijam" color="navy"> 
</font><a href="searchtool.asp"><font face="TH Baijam" color="navy">ค้นหาข้อมูลเครื่องมือ</font></a></b></span><font face="TH Baijam">&nbsp;</font>&nbsp;<font face="TH Baijam">&nbsp;</font></p>
<p align="center"><font face="TH Baijam" color="navy"><span style="font-size:28pt;"><b>เพิ่มข้อมูลเครื่องมือ</b></span></font></p>
    ...
    <table align="center" width="531" cellpadding="0" cellspacing="0">
        <tr>
            ...
            <td width="292" height="41">
                <p> <font face="TH Baijam"><input type="text" name="idtool" maxlength="11" style="font-family:'TH Mali Grade 6'; font-style:normal; font-weight:bold; font-size:16pt; color:maroon; background-color:rgb(204,153,255);" size="20"></font></p>
            </td>
        </tr>
        <tr>
            ...
            <td width="292" height="41">
                <p> <font face="TH Baijam"><input type="text" name="toolname" maxlength="100" style="font-family:'TH Mali Grade 6'; font-style:normal; font-weight:bold; font-size:16pt; color:maroon; background-color:rgb(204,153,255);" size="20"></font></p>
            </td>
        </tr>
        <tr>
            ...
            <td width="292" height="41">
<p align="left"><font face="TH Baijam"><input type="text" name="model" maxlength="100" style="font-family:'TH Mali Grade 6'; font-style:normal; font-weight:bold; font-size:16pt; color:maroon; background-color:rgb(204,153,255);" size="20"></font></p>
            </td>
        </tr>
        <tr>
...
<p><font face="TH Baijam"><span style="font-size:20pt;"><select name="idcategory2" size="1" type="text" style="font-family:'TH Mali Grade 6'; font-size:20; color:maroon; background-color:rgb(204,153,255); border-style:outset;">
        ...
        <tr>
            ...
            <td width="292" height="41">
<p align="left"><font face="TH Baijam"><input type="text" name="size" maxlength="30" style="font-family:'TH Mali Grade 6'; font-style:normal; font-weight:bold; font-size:16pt; color:maroon; background-color:rgb(204,153,255);" size="20"></font></p>
            </td>
        </tr>
        <tr>
            ...
            <td width="292" height="41">
<p align="left"><font face="TH Baijam"><input type="text" name="weight" maxlength="7" style="font-family:'TH Mali Grade 6'; font-style:normal; font-weight:bold; font-size:16pt; color:maroon; background-color:rgb(204,153,255);" size="10"></font></p>
            </td>
        </tr>
        <tr>
            ...
            <td width="292" height="41">
<p align="left"><font face="TH Baijam"><input type="text" name="color" maxlength="30" style="font-family:'TH Mali Grade 6'; font-style:normal; font-weight:bold; font-size:16pt; color:maroon; background-color:rgb(204,153,255);" size="20"></font></p>
            </td>
        </tr>
        <tr>
            ...
            <td width="292" height="41">
<p align="left"><font face="TH Baijam"><input type="text" name="details" maxlength="225" style="font-family:'TH Mali Grade 6'; font-style:normal; font-weight:bold; font-size:16pt; color:maroon; background-color:rgb(204,153,255);" size="20"></font></p>
            </td>
        </tr>
        <tr>
            ...
            <td width="292" height="41">
<p align="left"><font face="TH Baijam"><input type="text" name="unitprice" maxlength="10" style="font-family:'TH Mali Grade 6'; font-style:normal; font-weight:bold; font-size:16pt; color:maroon; background-color:rgb(204,153,255);" size="10"></font></p>
            </td>
        </tr>
        <tr>
            ...
            <td width="292" height="41">
<p align="left"><font face="TH Baijam"><input type="text" name="quantity" maxlength="2" style="font-family:'TH Mali Grade 6'; font-style:normal; font-weight:bold; font-size:16pt; color:maroon; background-color:rgb(204,153,255);" size="5"></font></p>
            </td>
        </tr>
        <tr>

...
<FORM METHOD=POST ACTION="saveeditmember2.asp?idmember=<%=idmember%>">
<%
...
<p align="center">&nbsp;<font face="TH Sarabun New" color="navy"><span style="font-size:28pt;"><b>แก้ไขข้อมูลสมาชิก</b></span></font></p>

    <table align="center" width="982" cellpadding="0" cellspacing="0">
        <tr>
            <td width="337" height="41">            <p align="right"><font face="TH Sarabun New" color="navy"><span style="font-size:16pt;"><b>รหัสสมาชิก</b></span></font></p>
            </td>
            ...
            <td width="587" height="41">
                <p>&nbsp;<font color="#3300CC" face="TH Baijam"><span style="font-size:16pt;"><%=idmember%></span></font></p>
            </td>
        </tr>
        <tr>
            ...
            <td width="587" height="41">
                <p>&nbsp;<font color="#3300CC" face="TH Baijam"><span style="font-size:16pt;"><%=pname%> 
                <%=fname
%> &nbsp; <%=lname%></span></font></p>
            </td>
        </tr>
        <tr>
            ...
            <td width="587" height="41">
                <p>&nbsp;<font color="#3300CC" face="TH Baijam"><span style="font-size:16pt;"><%=age%></span></font></p>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td width="587" height="41">
                <p>&nbsp;<font color="#3300CC" face="TH Baijam"><span style="font-size:16pt;"><%=agency%></span></font></p>
            </td>
        </tr>
        <tr>
            ...
            <td width="587" height="41">
                <p>&nbsp;<font color="#3300CC" face="TH Baijam"><span style="font-size:16pt;"><%=person
%></span></font></p>
            </td>
        </tr>
        <tr>
            ...
            <td width="587" height="41">
                <p>&nbsp;<font color="#3300CC" face="TH Baijam"><span style="font-size:16pt;"><%=address%></span></font></p>
            </td>
        </tr>
        <tr>
...
%></span></font></p>
        ...
        <tr>
            ...
            <td width="587" height="41">
                <p>&nbsp;<font color="#3300CC" face="TH Baijam"><span style="font-size:16pt;"><%=fax%></span></font></p>
            </td>
        </tr>
        <tr>
...
<p align="center"><font face="TH Sarabun New"><input type="submit" name="บันทึกข้อมูล" value="บันทึกข้อมูล" style="font-family:'TH Mali Grade 6'; font-style:normal; font-weight:bold; font-size:16; color:rgb(204,0,0); background-color:rgb(255,102,204);"></font></p>
</FORM>
</body>

...
<head>
<title>ค้นหาข้อมูลเครื่องมือ</title>
...
</font><a href="inputmember.asp"><font face="TH Baijam" color="navy">เพิ่มข้อมูลเครื่องมือ</font></a><font face="TH Baijam" color="navy"> 
</font><a href="searchmember.asp"><font face="TH Baijam" color="#DA4453">ค้นหาข้อมูลเครื่องมือ</font></a></b></span></p>
<form method="post" action="searchtool.asp">
    <p align="center"><font face="TH Baijam" color="#CC0000"><span style="font-size:28pt;"><b><u>ค้นหาข้อมูลเครื่องมือ</u></b></span></font></p>
    ...
    <tr>
        ...
        <td width="220" height="53">
            <p align="left"><font face="TH Baijam">&nbsp;</font><font face="TH Baijam" color="black"><span style="font-size:16pt;"><select name="searchtype" size="1" type="text" style="font-family:'TH Mali Grade 6'; font-size:20; color:rgb(0,0,153); background-color:rgb(255,204,0); border-style:outset;">
                ...
                <option value="1">รหัสเครื่องมือ</option>
                <option value="2">ชื่อเครื่องมือ</option>
                <option value="3">รุ่น</option>
            </select></span></font></p>
        </td>
    </tr>
</table>
...
<font face="TH Baijam" color="black"><span style="font-size:16pt;"><INPUT TYPE="checkbox" name="dele"  value="<%=rs("idtool")%>" id="chk"></span></font>
        ...
        <td width="174" height="49">                <p align="right"><font face="TH Baijam" color="black"><span style="font-size:16pt;"><INPUT type="Button" Onclick="location.href='showalltool.asp?id=<%=rs("idtool")%>'"  style="font-family:Tahoma; font-size:12px; border-width:1; border-style:solid; cursor:hand;" value="แสดงข้อมูลทั้งหมด"></span></font></p>
        </td>
        <td width="73" height="49">                <p align="right"><font face="TH Baijam" color="white"><span style="font-size:18pt;"><INPUT type="Button" Onclick="location.href='edittool.asp?id=<%=rs("idtool")%>'"  style="font-family:Tahoma; font-size:12px; border-width:1; border-style:solid; cursor:hand;" value="แก้ไข"></span></font></p>
        </td>
        <td width="50" height="49">                <p align="right"><font face="TH Baijam" color="white"><span style="font-size:18pt;"><INPUT type="Button" Onclick="location.href='deltool.asp?id=<%=rs("idtool")%>'"  style="font-family:Tahoma; font-size:12px; border-width:1; border-style:solid; cursor:hand;" value="ลบ"></span></font></p>
        </td>
    </tr>
    <tr>
        <td width="220" colspan="2" height="47">            <p align="right"><font face="TH Baijam" color="navy"><span style="font-size:16pt;"><b>รหัสเครื่องมือ</b></span></font></p>
        </td>
    ...
    <tr>
        <td width="220" colspan="2" height="45">            <p align="right"><font face="TH Baijam" color="navy"><span style="font-size:16pt;"><b>ชื่อเครื่องมือ</b></span></font></p>
        </td>
        ...
        <td width="301" height="45">
            <p><font color="#990033" face="TH Baijam"><span style="font-size:16pt;">&nbsp;<%=rs("toolname")%> 
                &nbsp;</span></font><font face="TH Baijam" color="navy"><span style="font-size:16pt;"><b>รุ่น</b></span></font><font color="#990033" face="TH Baijam"><span style="font-size:16pt;"> 
            <%=rs("model")%></span></font></p>
        </td>
        <td width="207" height="45">            <p align="right"><font face="TH Baijam" color="navy"><span style="font-size:16pt;"><b>รายละเอียด</b></span></font></p>
        </td>
    ...
    <tr>
        <td width="220" colspan="2" height="45">            <p align="right"><font face="TH Baijam" color="navy"><span style="font-size:16pt;"><b>สี</b></span></font></p>
        </td>
        <td width="77" height="45">                            <p align="center"><font face="TH Baijam"><img src="icons8-leaf-fluttering-in-wind-48.png" width="38" height="38" border="0"></font></p>
        </td>
        <td width="301" height="45">
        ...
        <td width="207" height="45">            <p align="right"><font face="TH Baijam" color="navy"><span style="font-size:16pt;"><b>หมวดหมู่</b></span></font></p>
        </td>
        <td width="56" height="45">                            <p align="center"><font face="TH Baijam"><img src="icons8-leaf-fluttering-in-wind-48.png" width="38" height="38" border="0"></font></p>
        </td>
			<%
    ...
    <tr>
        <td width="220" colspan="2" height="45">            <p align="right"><font face="TH Baijam" color="navy"><span style="font-size:16pt;"><b>ราคาต่อหน่วย</b></span></font></p>
        </td>
        <td width="77" height="45">                            <p align="center"><font face="TH Baijam"><img src="icons8-leaf-fluttering-in-wind-48.png" width="38" height="38" border="0"></font></p>
        </td>
        <td width="301" height="45">
            <p><font color="#990033" face="TH Baijam"><span style="font-size:16pt;">&nbsp;<%=rs("unitprice")%> 
                </span></font><font face="TH Baijam" color="navy"><span style="font-size:16pt;"><b>บาท</b></span></font></p>
        </td>
        <td width="207" height="45">            <p align="right"><font face="TH Baijam" color="navy"><span style="font-size:16pt;"><b>จำนวนในคลัง</b></span></font></p>
        </td>
        <td width="56" height="45">                            <p align="center"><font face="TH Baijam"><img src="icons8-leaf-fluttering-in-wind-48.png" width="38" height="38" border="0"></font></p>
        </td>
        <td width="297" colspan="3" height="45">

...
<FORM METHOD=POST ACTION="saveeditborrow.asp">
    <font color="#000066">&nbsp;</font></FORM>
<form method="post" action="saveeditborrow.asp">
    <p><font color="#000066"><%
...
<FORM METHOD=POST ACTION="saveeditborrow.asp">
<p align="center"><font color="#000066">&nbsp;</font><font face="TH Baijam" color="#000066">&nbsp;<span style="font-size:28pt;"><b>แก้ไขข้อมูลใบยืมเครื่องมือ</b></span></font></p>
    ...
    <table align="center" width="637" cellpadding="0" cellspacing="0">
		...
		%>
            <td width="366" height="41">
                ...
                <%=rs("fname")%>&nbsp;<%=rs("lname")%>&nbsp;</span></font><font face="TH Baijam" color="#000066"><span style="font-size:16pt;"><b>(อายุ </b></span></font><font color="#000066" face="TH Baijam"><span style="font-size:16pt;"><%=rs("age")%></span></font><font face="TH Baijam" color="#000066"><span style="font-size:16pt;"><b>) 
                </b></span></font><font color="#000066" face="TH Baijam"><span style="font-size:16pt;"><%=rs("agency")%> 
                </span></font><font face="TH Baijam" color="#000066"><span style="font-size:16pt;"><b>โทรสาร[</b></span></font><font color="#000066" face="TH Baijam"><span style="font-size:16pt;"><%=rs("fax")%></span></font><font face="TH Baijam" color="#000066"><span style="font-size:16pt;"><b>]</b></span></font></p>
            </td>
        </tr>
        <tr>
		...
		%>
            ...
            <td width="366" height="41">
                <p><font color="#000066" face="TH Baijam"><span style="font-size:16pt;"><%=rs("idtool")%><%=rs("toolname")%>&nbsp;รุ่น<%=rs("model")%> 
                สี<%=rs("color")%> ราคาต่อหน่วย<%=rs("unitprice")%> บาท</span></font></p>
            </td>
        </tr>
        <tr>
		...
		%>
            ...
            <td width="366" height="41">
                ...
                <%=rs("lname")%> (อายุ <%=rs("age")%>) เบอร์โทรศัพท์ [<%=rs("phone")%>]</span></font></p>
            </td>
        </tr>
        <tr>

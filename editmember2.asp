...
</font><a href="showallmember2.asp?idmember=<%=idmember%>"><font face="TH Baijam" color="#000097">แสดงข้อมูลสมาชิก</font></a><font face="TH Baijam" color="navy"> 
</font><a href="editmember2.asp?idmember=<%=idmember%>"><font face="TH Baijam" color="#F28853">แก้ไขข้อมูลสมาชิก</font></a></b></span></p>
...
<form method="post" action="showeditmember2.asp?idmember=<%=idmember%>">
    <table align="center" width="982" cellpadding="0" cellspacing="0">
        ...
        <tr>
            ...
            <td width="587" height="41">
                <p>&nbsp;<font face="TH Sarabun New" color="navy"><span style="font-size:16pt;"><input type="radio" name="sex" value="ชาย" <%If rs("sex")="ชาย"then%>checked<%End if%>> 
            <b>ชาย &nbsp;&nbsp;&nbsp; 
        ...
        <tr>
            ...
            <td width="587" height="41">
                <p>&nbsp;<font face="TH Sarabun New" color="navy"><span style="font-size:16pt;"><input type="radio" name="person" value="ภาครัฐ" <%If rs("person")="ภาครัฐ"then%>checked<%End if%>><b>ภาครัฐ 

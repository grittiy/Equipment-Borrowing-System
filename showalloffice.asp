...
<INPUT TYPE="hidden" NAME="idoffice"  value="<%=rs("idoffice")%>">
    ...
    <p align="center"><font face="TH Baijam" color="navy"><span style="font-size:28pt;"><b>แสดงข้อมูลเจ้าหน้าที่ทั้งหมด</b></span></font></p>
...
<p align="right"><font color="#003333"><img src="showpicprofile.asp" style="border : solid #6BA7C4 2px;"></font>
        ...
        <tr>
            <td width="181" height="43">
                <p align="right"><font face="TH Baijam">&nbsp;</font><font face="TH Sarabun New" color="#003333"><span style="font-size:16pt;"><b>รูปภาพ</b></span></font></p>
            </td>
            <td width="58" height="43">
                <p align="center"><font face="TH Baijam"><img src="icons8-leaf-fluttering-in-wind-48.png" width="38" height="38" border="0"></font></p>
            </td>
    ...
    <p align="center"><span style="font-size:16pt;"><font color="#003333"><input type="submit" name="ตกลง" value="ใส่/เปลี่ยนรูปภาพ" style="font-family:'TH Mali Grade 6'; font-size:16; color:black; background-color:rgb(153,255,255);"></font></span></FORM>
